...
try{
 ...
 out.println("<center>");
 out.println("<p><u><strong>BONAFIDE CERTIFICATE</strong></u></p></center><p style='line-height: 25px;'>");
...
out.println("<input type='submit' value='Custom Bonafide Certificate' formaction='/bcsctc/BC.html'>");
