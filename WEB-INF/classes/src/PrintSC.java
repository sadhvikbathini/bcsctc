...
public class PrintSC extends HttpServlet {
public PrintSC(){}
...
String branch= request.getParameter("branch");
   ...
   out.println("<html><title>Study & Conduct Certificate</title>");
 ...
 out.println("<center>");
 out.println("<p><u><strong>STUDY & CONDUCT CERTIFICATE</strong></u></p></center>");
