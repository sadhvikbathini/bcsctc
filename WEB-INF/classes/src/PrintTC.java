...
String idmarks= request.getParameter("idmarks");
 ...
 out.println("<td>"+conduct+"</td></tr><tr>");
 out.println("<td><strong>Identification Marks : </strong></td>");
 out.println("<td>"+idmarks+"</td></tr>");
 out.println("</table>");
